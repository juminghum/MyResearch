...
class FarPathLogic extends Module {
  val io = IO(new Bundle {
    val IN_AB_R = Input(UInt(48.W))
    val IN_AB_S = Input(UInt(39.W))
    val IN_CD_R = Input(UInt(48.W))
    val IN_CD_S = Input(UInt(39.W))
  ...
  val small_S = Wire(UInt(39.W))
  val large_R = Wire(UInt(48.W))
  val large_S = Wire(UInt(39.W))
  ...
  Aligned_large_S := large_S(37, 0) ## zero_vec(12, 0)
  ...
  val Align = Module(new MantissaAlignment)
...
class MantissaAlignment extends Module {
  val io = IO(new Bundle {
    val INAB_R = Input(UInt(48.W))
    val INAB_S = Input(UInt(39.W))
...
*/
  switch (io.shift_val) {
    is(0.U) {
      AB_S_buf := io.INAB_S(37, 0)  ## zero_vec(12, 0) //39+3=42
      AB_R_buf := io.INAB_R ## zero_vec(2, 0) //48+3=51
    }
    is(1.U) {
      AB_S_buf := "b0".U ## io.INAB_S(37, 0) ## zero_vec(11,0) //5+22+1=28
      AB_R_buf := "b0".U ## io.INAB_R ## zero_vec(1, 0)
    }
    is(2.U) {
      AB_S_buf := "b00".U ## io.INAB_S(37, 0)  ## zero_vec(10, 0) //6+22=28
      AB_R_buf := "b00".U ## io.INAB_R ## zero_vec(1)
    }
    is(3.U) {
      AB_S_buf := "b000".U ## io.INAB_S(37, 0) ## zero_vec(9, 0)   //7+20+1=28
      AB_R_buf := "b000".U ## io.INAB_R
    }
    is(4.U) {
      AB_S_buf := "b0000".U ## io.INAB_S(37, 0) ## zero_vec(8, 0)   //7+20+1=28
      AB_R_buf := "b0000".U ## io.INAB_R(47, 2) ## (io.INAB_R(1) | io.INAB_R(0))
    }
    is(5.U) {
      AB_S_buf := "b0000_0".U ## io.INAB_S(37, 0) ## zero_vec(7, 0)   //7+20+1=288
      AB_R_buf := "b0000_0".U ## io.INAB_R(47, 3) ## (io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(6.U) {
      AB_S_buf := "b0000_00".U ## io.INAB_S(37, 0) ## zero_vec(6, 0)   //7+20+1=288
      AB_R_buf := "b0000_00".U ## io.INAB_R(47, 4) ## (io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(7.U) {
      AB_S_buf := "b0000_000".U ## io.INAB_S(37, 0) ## zero_vec(5, 0)   //7+20+1=288
      AB_R_buf := "b0000_000".U ## io.INAB_R(47, 5) ## (io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(8.U) {
      AB_S_buf := "b0000_0000".U ## io.INAB_S(37, 0) ## zero_vec(4, 0)   //7+20+1=288
      AB_R_buf := "b0000_0000".U ## io.INAB_R(47, 6) ## (io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(9.U) {
      AB_S_buf := "b0000_0000_0".U ## io.INAB_S(37, 0) ## zero_vec(3, 0)   //7+20+1=288//13+14+1=28
    ...
    is(10.U) {
      AB_S_buf := "b0000_0000_00".U ## io.INAB_S(37, 0) ## zero_vec(2, 0)   //7+20+1=288
    ...
    is(11.U) {
      AB_S_buf := "b0000_0000_000".U ## io.INAB_S(37, 0) ## zero_vec(1, 0)   //7+20+1=288
    ...
    is(12.U) {
      AB_S_buf := "b0000_0000_0000".U ## io.INAB_S(37, 0) ## zero_vec(0)   //7+20+1=288
    ...
    is(13.U) {
      AB_S_buf := "b0000_0000_0000_0".U ## io.INAB_S(37, 0)
    ...
    is(14.U) {
      AB_S_buf := "b0000_0000_0000_00".U ## io.INAB_S(37, 2) ## (io.INAB_S(1) | io.INAB_S(0)) //18+9+1=28
    ...
    is(15.U) {
      AB_S_buf := "b0000_0000_0000_000".U ## io.INAB_S(37, 3) ## (io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //19+8+1=28
    ...
    is(16.U) {
      AB_S_buf := "b0000_0000_0000_0000".U ## io.INAB_S(37, 4) ## (io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //20+7+1=28
    ...
    is(17.U) {
      AB_S_buf := "b0000_0000_0000_0000_0".U ## io.INAB_S(37, 5) ## (io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //21+6+1=28
    ...
    is(18.U) {
      AB_S_buf := "b0000_0000_0000_0000_00".U ## io.INAB_S(37, 6) ## (io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //22+5+1=28
    ...
    is(19.U) {
      AB_S_buf := "b0000_0000_0000_0000_000".U ## io.INAB_S(37, 7) ## (io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //23+4+1=28
    ...
    is(20.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000".U ## io.INAB_S(37, 8) ## (io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //24+3+1=28
    ...
    is(21.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 9) ## (io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //25+2+1=28
    ...
    is(22.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 10) ## (io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //26+1+1=28
    ...
    is(23.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 11) ## (io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(24.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 12) ## (io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(25.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 13) ## (io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(26.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 14) ## (io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(27.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 15) ## (io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(28.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 16) ## (io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(29.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 17) ## (io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(30.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 18) ## (io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(31.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 19) ## (io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(32.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 20) ## (io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(33.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 21) ## (io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(34.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 22) ## (io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(35.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 23) ## (io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(36.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 24) ## (io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
    ...
    is(37.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 25) ## (io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_R(47, 35) ## (io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(38.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 26) ## (io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_R(47, 36) ## (io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(39.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 27) ## (io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_R(47, 37) ## (io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(40.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 28) ## (io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_R(47, 38) ## (io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(41.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 29) ## (io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_R(47, 39) ## (io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(42.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 30) ## (io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_R(47, 40) ## (io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(43.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 31) ## (io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_R(47, 41) ## (io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }

    is(44.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 32) ## (io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_R(47, 42) ## (io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }

    is(45.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37, 33) ## (io.INAB_S(32) | io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_R(47, 43) ## (io.INAB_R(42) | io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(29) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(46.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_S(37, 34) ## (io.INAB_S(33) | io.INAB_S(32) | io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## io.INAB_R(47, 44) ## (io.INAB_R(43) | io.INAB_R(42) | io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(47.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_S(37, 35) ## (io.INAB_S(34) | io.INAB_S(33) | io.INAB_S(32) | io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_000".U ## io.INAB_R(47, 45) ## (io.INAB_R(44) | io.INAB_R(43) | io.INAB_R(42) | io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(48.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_S(37, 36) ## (io.INAB_S(35) | io.INAB_S(34) | io.INAB_S(33) | io.INAB_S(32) | io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000".U ## io.INAB_R(47, 46) ## (io.INAB_R(45) | io.INAB_R(44) | io.INAB_R(43) | io.INAB_R(42) | io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(49.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_S(37) ## (io.INAB_S(36) | io.INAB_S(35) | io.INAB_S(34) | io.INAB_S(33) | io.INAB_S(32) | io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0".U ## io.INAB_R(47) ## (io.INAB_R(46) | io.INAB_R(45) | io.INAB_R(44) | io.INAB_R(43) | io.INAB_R(42) | io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
    is(50.U) {
      AB_S_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## (io.INAB_S(37) | io.INAB_S(35) | io.INAB_S(34) | io.INAB_S(33) | io.INAB_S(32) | io.INAB_S(31) | io.INAB_S(30) | io.INAB_S(29) | io.INAB_S(28) | io.INAB_S(27) | io.INAB_S(26) | io.INAB_S(25) | io.INAB_S(24) | io.INAB_S(23) | io.INAB_S(22) | io.INAB_S(21) | io.INAB_S(20) | io.INAB_S(19) | io.INAB_S(18) | io.INAB_S(17) | io.INAB_S(16) | io.INAB_S(15) | io.INAB_S(14) | io.INAB_S(13) | io.INAB_S(12) | io.INAB_S(11) | io.INAB_S(10) | io.INAB_S(9) | io.INAB_S(8) | io.INAB_S(7) | io.INAB_S(6) | io.INAB_S(5) | io.INAB_S(4) | io.INAB_S(3) | io.INAB_S(2) | io.INAB_S(1) | io.INAB_S(0)) //27+0+1=28
      AB_R_buf := "b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_00".U ## (io.INAB_R(47) | io.INAB_R(46) | io.INAB_R(44) | io.INAB_R(43) | io.INAB_R(42) | io.INAB_R(41) | io.INAB_R(40) | io.INAB_R(39) | io.INAB_R(38) | io.INAB_R(37) | io.INAB_R(36) | io.INAB_R(35) | io.INAB_R(34) | io.INAB_R(33) | io.INAB_R(32) | io.INAB_R(31) | io.INAB_R(30) | io.INAB_R(29) | io.INAB_R(28) | io.INAB_R(27) | io.INAB_R(26) | io.INAB_R(25) | io.INAB_R(24) | io.INAB_R(23) | io.INAB_R(22) | io.INAB_R(21) | io.INAB_R(20) | io.INAB_R(19) | io.INAB_R(18) | io.INAB_R(17) | io.INAB_R(16) | io.INAB_R(15) | io.INAB_R(14) | io.INAB_R(13) | io.INAB_R(12) | io.INAB_R(11) | io.INAB_R(10) | io.INAB_R(9) | io.INAB_R(8) | io.INAB_R(7) | io.INAB_R(6) | io.INAB_R(5) | io.INAB_R(4) | io.INAB_R(3) | io.INAB_R(2) | io.INAB_R(1) | io.INAB_R(0))
    }
  }
